...
// translateHref, LegalRow y CommercialNav vivian aca y se exportaban a otras 4 paginas:
// importar la barra arrastraba estas 765 lineas al bundle. Ahora viven en components/.
      ...
      <section className="bg-[#0d1629] pt-14 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-10 flex-1 flex flex-col justify-center">
          <div className="grid lg:grid-cols-[1fr_1.35fr] gap-6 items-center">
            ...
            {/* ── Derecha: imagen hero ── */}
            <div className="relative hidden lg:flex items-center justify-center lg:-mt-24">
              <img
                src="/hero-devices-v3.png"
                alt="CloudBooks — Biblioteca multi-formato en todos los dispositivos"
                className="w-full max-w-[599px] h-auto object-contain opacity-[0.50]"
                draggable={false}
              />
            </div>
          </div>
      ...
      <section className="py-20 bg-[#0d1629] relative">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-3">
            {[
              { cert:"AI-200", title:"Azure AI Developer",            status:"active",   note:"Collection Pack + Visual Atlas disponibles" },
