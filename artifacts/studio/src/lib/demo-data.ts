...
const RUNS: GenerationRun[] = [
  { id:"run-001", pageId:"01", type:"full_generation", status:"completed", model:"gpt-4o", version:"v1", note:"[Demo seed / configuración obsoleta] Primera generación con gpt-4o — modelo reemplazado por gpt-4o-mini", createdAt:"2026-05-05T10:30:00Z", completedAt:"2026-05-05T10:32:45Z", promptTokens:2840, completionTokens:1920 },
  { id:"run-002", pageId:"01", type:"selective_regeneration", status:"completed", model:"gpt-4o", version:"v2", note:"[Demo seed / configuración obsoleta] gpt-image-1 reemplazado por gpt-image-2", createdAt:"2026-05-12T14:20:00Z", completedAt:"2026-05-12T14:21:30Z", promptTokens:1450, completionTokens:890 },
  { id:"run-003", pageId:"01", type:"selective_regeneration", status:"completed", model:"gpt-4o", version:"v3", note:"[Demo seed / configuración obsoleta] Layout libre — reemplazado por golden master v24", createdAt:"2026-05-18T11:00:00Z", completedAt:"2026-05-18T11:01:20Z", promptTokens:980, completionTokens:620 },
  { id:"run-004", pageId:"02", type:"full_generation", status:"completed", model:"gpt-4o", version:"v1", note:"[Demo seed / configuración obsoleta]", createdAt:"2026-05-08T09:15:00Z", completedAt:"2026-05-08T09:17:40Z", promptTokens:2760, completionTokens:1870 },
  { id:"run-005", pageId:"02", type:"selective_regeneration", status:"completed", model:"gpt-4o", version:"v2", note:"[Demo seed / configuración obsoleta]", createdAt:"2026-05-19T16:45:00Z", completedAt:"2026-05-19T16:46:50Z", promptTokens:1120, completionTokens:740 },
  { id:"run-006", pageId:"03", type:"full_generation", status:"completed", model:"gpt-4o", version:"v1", note:"[Demo seed / configuración obsoleta]", createdAt:"2026-05-10T11:00:00Z", completedAt:"2026-05-10T11:02:30Z", promptTokens:2920, completionTokens:1980 },
  { id:"run-007", pageId:"03", type:"selective_regeneration", status:"completed", model:"gpt-4o", version:"v2", note:"[Demo seed / configuración obsoleta]", createdAt:"2026-05-20T10:30:00Z", completedAt:"2026-05-20T10:31:40Z", promptTokens:1340, completionTokens:820 },
  { id:"run-008", pageId:"04", type:"full_generation", status:"completed", model:"gpt-4o", version:"v1", note:"[Demo seed / configuración obsoleta]", createdAt:"2026-05-11T09:00:00Z", completedAt:"2026-05-11T09:02:20Z", promptTokens:2680, completionTokens:1820 },
  { id:"run-009", pageId:"04", type:"selective_regeneration", status:"completed", model:"gpt-4o", version:"v2", note:"[Demo seed / configuración obsoleta]", createdAt:"2026-05-20T14:00:00Z", completedAt:"2026-05-20T14:01:30Z", promptTokens:1180, completionTokens:780 },
  { id:"run-010", pageId:"05", type:"full_generation", status:"completed", model:"gpt-4o", version:"v1", note:"[Demo seed / configuración obsoleta]", createdAt:"2026-05-21T10:00:00Z", completedAt:"2026-05-21T10:02:15Z", promptTokens:2540, completionTokens:1760 },
  { id:"run-011", pageId:"06", type:"full_generation", status:"completed", model:"gpt-4o", version:"v1", note:"[Demo seed / configuración obsoleta]", createdAt:"2026-05-21T11:00:00Z", completedAt:"2026-05-21T11:02:40Z", promptTokens:2610, completionTokens:1790 },
  { id:"run-012", pageId:"10", type:"full_generation", status:"completed", model:"gpt-4o", version:"v1", note:"[Demo seed / configuración obsoleta]", createdAt:"2026-05-22T09:30:00Z", completedAt:"2026-05-22T09:32:20Z", promptTokens:2480, completionTokens:1700 },
];
