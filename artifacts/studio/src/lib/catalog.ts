...
// FormatDef y FORMATS se movieron a shared/ porque el cockpit tambien los usa.
// Se importan (el catalogo los consume mas abajo) y se re-exportan, para no tocar las
// paginas de tienda que ya los venian importando desde aca.
import { FORMATS, type FormatDef } from "@/shared/formats";
export { FORMATS };
